    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-50 to-slate-100 text-slate-900">
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-10 lg:py-10">
        <div className="mb-7 rounded-3xl border border-slate-200/90 bg-white/90 p-6 shadow-sm shadow-slate-200/60 backdrop-blur sm:p-7">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">Starlink Job Order</h1>
          <p className="mt-2 max-w-2xl text-sm text-slate-600 sm:text-base">
            Select the job scope and instantly view the indicative price.
          </p>
        </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[1.2fr_0.88fr]">
            ...
            {mode === 'site' ? (
                <div key="site" className="transition-opacity duration-200">
                  <div className="space-y-5">
                    {sectionCard('3', 'Choose install type', (
                        ...
                        {([
                          ...
                          <label
                            ...
                            className={`flex cursor-pointer items-center justify-between rounded-xl border px-3 py-2 text-sm transition ${
                              installType === value
                                ? 'border-sky-500 bg-gradient-to-r from-sky-50 to-cyan-50 text-sky-900 ring-2 ring-sky-100'
                                : 'border-slate-200 bg-white hover:border-slate-300 hover:bg-slate-50'
                            }`}
                          >
                            <span>{label}</span>
                    ...
                    {sectionCard('4', 'Choose mounting accessory', (
                    ...
                    {sectionCard('5', 'Optional hardware and site conditions', (
                ...
                <div key="fleet" className="transition-opacity duration-200">
                  <div className="space-y-5">
                    {sectionCard('3', 'Choose fleet package', (
                      <div className="space-y-2">
                    ...
                    {sectionCard('4', 'Conditions needing review', (
                      <div className="space-y-2">
                        {[
          ...
          <aside className="xl:sticky xl:top-6 xl:h-fit">
            ...
            >
              ...
              <div className="mt-6 rounded-xl border border-sky-200 bg-gradient-to-r from-sky-50 to-cyan-50 p-4">
                <p className="text-sm text-slate-600">Indicative subtotal excl. GST</p>
                <p className="mt-1 text-3xl font-semibold tracking-tight text-slate-900">{money.format(pricing.subtotal)}</p>
              </div>
              ...
              <div className="mt-6 grid gap-2.5 sm:grid-cols-2">
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-sky-700 to-cyan-700 px-4 py-2.5 text-sm font-medium text-white shadow-sm shadow-sky-300/40 transition-all duration-300 hover:-translate-y-0.5 hover:from-sky-800 hover:to-cyan-800"
                >
                  Show me my price
                </button>
                <button
                  onClick={copySummary}
                  className="rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-slate-100"
                >
                  Copy client summary
                </button>
              </div>
